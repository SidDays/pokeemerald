...
const u32 gEventObjectPic_ProfPine[] = INCBIN_U32("graphics/event_objects/pics/people/prof_pine.4bpp");
...
const u16 gEventObjectPalette_ProfPine[] = INCBIN_U16("graphics/event_objects/palettes/prof_pine.gbapal");
