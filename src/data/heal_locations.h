static const struct HealLocation sHealLocations[] =
{
    ...
    {MAP_GROUP(CHARLESBURY), MAP_NUM(CHARLESBURY), 47, 25},
    {MAP_GROUP(SERENITY_TOWN), MAP_NUM(SERENITY_TOWN), 37, 18},
    {MAP_GROUP(COASTAL1), MAP_NUM(COASTAL1), 9, 5},
    {MAP_GROUP(DARK1), MAP_NUM(DARK1), 13, 22},
};
